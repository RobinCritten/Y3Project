...
def RandomSample(lstPrecursor,i,lstSuccessor,m,res):
    
    pre_density = i/len(lstPrecursor) #density of precursor config
    
    #change back to 10 mil
...
if __name__ == "__main__":
    ...
    fileName = "2d4mTestingRandom.csv"
    ########################################################
    ...
    for i in range(len(lstPrecursor)+1):
        ...
        if math.comb(len(lstPrecursor),i) < 10000000:
            combination(lstPrecursor,len(lstPrecursor),i,lstSuccessor,m,res)
        else:
            print("Random Sample")
            RandomSample(lstPrecursor,i,lstSuccessor,m,res)
        #RandomSample(lstPrecursor,i,lstSuccessor,m,res) #ten random samples for each density
